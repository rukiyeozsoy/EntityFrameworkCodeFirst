...
namespace EntityCodeFirst
{
    public partial class Tedarikciler : Form
    {
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select *from Tedarikcilers where TedarikciAd like '%" + textBox5.Text + "%'", baglanti);
            DataSet ds = new DataSet();
            da.Fill(ds);
            dataGridView1.DataSource = ds.Tables[0];
        }
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select *from Tedarikcilers order by TedarikciAd asc", baglanti);
            DataSet ds = new DataSet();
            da.Fill(ds);
            dataGridView1.DataSource = ds.Tables[0];
        }
